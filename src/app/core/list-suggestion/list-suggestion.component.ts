...
export class ListSuggestionComponent {
  ...
  addToFavorites(suggestion: Suggestion): void {
    if (suggestion.status !== 'refusee' && !this.favoriteSuggestions.find(fav => fav.id === suggestion.id)) {
  ...
  // Getter pour les catégories uniques
  ...
  // Vérifier si les boutons doivent être affichés
